$(document).ready(function(){
    ...
    $(window).on("scroll", function() {
      if($(window).scrollTop() > 50) {
          ...
          $("#header-img").attr("src", "image-dichthuat/kemtrang-logo.png");
      } else {
          //xóa thuộc tính nền để nó trở lại trong suốt (được xác định trong css của bạn)
         $("#header").removeClass("active-header");
         $(".menu-link").removeClass("active-menu-links");
         $("#header-img").attr("src", "image-dichthuat/black-logo.png");
      }
  });
