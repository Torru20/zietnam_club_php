...
<div id="popup" style="display: none;">
    ...
    <form method="post" enctype='multipart/form-data'>
        ...
        <div class="form-floating">
            <textarea class="form-control" name='description' placeholder="say sth about your home sweet home" id="floatingTextarea2" style="height: 100px"></textarea>
            <label for="floatingTextarea2">Description</label>
        </div>
        <div class="form-floating mb-3">
            <input type="text" class="form-control" name='price' id="floatingInput" placeholder="Ex: 1000000 (it need to be VNĐ/USD, pls note in description)">
        ...
        <div class="btn-post-form">
            ...
            <button type="submit" name="post-rent">Post</button>
        </div>
    </form>
