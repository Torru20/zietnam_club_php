                        ...
                        <div class="notification-wrapper">
                            <div class="notification-inner">
                                <div class="notification-header">
                                    ...
                                    <div class="notification-tweet">
                                        <a href="<?php echo BASE_URL?>profile_page.php?username=<?php echo $data->username;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> repost your <?php if($data->tweetBy === $user_id){echo 'Post';}else{echo 'Repost';}?> - <span><?php echo $getFromU->timeAgo($data->time);?></span>
                                    </div>
                                    <div class="notification-footer">
                                        <div class="noti-footer-inner">
